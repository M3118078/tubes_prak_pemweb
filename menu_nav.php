					...
					<div class="col">
						...
						<div class="page_menu_content">
							...
							<ul class="page_menu_nav">
								<li class="page_menu_item"><a href="index.php?target=home">Home<i class="fas fa-angle-down"></i ></a></li>
								<li class="page_menu_item"><a href="index.php?target=deals">Super Deals<i class="fas fa-angle-down"></i></a></li>
								<li class="page_menu_item"><a href="index.php?target=products">Products<i class="fas fa-angle-down"></i></a></li>
								<li class="page_menu_item"><a href="index.php?target=blog">blog<i class="fa fa-angle-down"></i></a></li>
								<li class="page_menu_item"><a href="index.php?target=contact">contact<i class="fa fa-angle-down"></i></a></li>
							</ul>
